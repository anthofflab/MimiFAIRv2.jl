...
function create_fair_monte_carlo(n_samples::Int; emissions_scenario::String="ssp585", start_year::Int=2000, end_year::Int=2300)
    ...
    gas_params               = DataFrame(load(joinpath(@__DIR__, "..", "data", "constrained_parameters", "julia_constrained_gas_cycle_parameters_average_probs.csv")))
    indirect_forcing_params  = DataFrame(load(joinpath(@__DIR__, "..", "data", "constrained_parameters", "julia_constrained_indirect_forcing_parameters_average_probs.csv")))
    exogenous_forcing_params = DataFrame(load(joinpath(@__DIR__, "..", "data", "constrained_parameters", "julia_constrained_exogenous_forcing_parameters_average_probs.csv")))
